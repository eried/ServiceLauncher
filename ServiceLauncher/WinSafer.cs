...
namespace ServiceLauncher
{
    public class WinSafer
    {
        ...
        ///     The returned SAFER_LEVEL_HANDLE. When you have finished using the handle, release it by
        ///     calling the SaferCloseLevel function.
        /// </param>
        ...
        /// </summary>
        /// <param name="levelHandle">
        ///     SAFER_LEVEL_HANDLE that contains the restrictions to place on the input token. Do not pass
        ///     handles with a LevelId of SAFER_LEVELID_FULLYTRUSTED or SAFER_LEVELID_DISALLOWED to this function. This is because
        ///     SAFER_LEVELID_FULLYTRUSTED is unrestricted and SAFER_LEVELID_DISALLOWED does not contain a token.
        /// </param>
        /// <param name="inAccessToken">
        ///     Token to be restricted. If this parameter is NULL, the token of the current thread will be
        ///     used. If the current thread does not contain a token, the token of the current process is used.
        /// </param>
        ...
        /// <summary>
        ///     The SaferCloseLevel function closes a SAFER_LEVEL_HANDLE that was opened by using the SaferIdentifyLevel function
        ///     or the SaferCreateLevel function.
        /// </summary>
    ...
    public enum SaferTokenBehaviour : uint
    {
        ...
        /// <summary>
        ///     If the OutAccessToken parameter is not more restrictive than the InAccessToken parameter, the OutAccessToken
    ...
    public enum SaferLevel : uint
    {
        ...
        /// <summary>
        ///     Allows programs to execute with access only to resources granted to open well-known groups, blocking access to
        ///     Administrator and Power User privileges and personally granted rights.
        /// </summary>
        Untrusted = 0x1000,

        /// <summary>
        ///     Software cannot access certain resources, such as cryptographic keys and credentials, regardless of the user
        ///     rights of the user.
        /// </summary>
        Constrained = 0x10000,

        /// <summary>
        ///     Allows programs to execute as a user that does not have Administrator or Power User user rights. Software can
